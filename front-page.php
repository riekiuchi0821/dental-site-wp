    ...
    <main>
      ...
      <section id="fv" class="fv-top">
        <picture class="fv-area-top">
          ...
          <img
            class="fv-image fv-image--center"
            src="<?php echo get_template_directory_uri(); ?>/img/hero-1.jpg"
            alt="ファーストビュー画像"
          />
        </picture>
        <div class="fv-copy">
          ...
          <div class="news-block">
            ...
            <ul class="news-list">
              <li class="news-item">
                ...
                <p class="news-text">休診のお知らせ　7/7(火)</p>
              </li>
              <li class="news-item">
                <span class="news-date">2026.07.01</span>
                <p class="news-text">夏休み中の診療について</p>
              </li>
              <li class="news-item">
                <span class="news-date">2026.07.01</span>
                <p class="news-text">診療時間の変更について　7/14(火)</p>
              </li>
            </ul>
        ...
        <div class="container">
          <div class="concept-contents">
            ...
            <div class="concept-explanation">
              ...
              <img
                class="concept-explanation-img"
                src="<?php echo get_template_directory_uri(); ?>/img/concept-2.jpg"
                alt="相談する患者"
              />
            </div>
          </div>
          <div class="concept-important-points">
            ...
            <div class="concept-button">
              <a href="concept/index.html" class="primary-button"
                >詳しく見る →</a
              >
            </div>
          </div>
            ...
            <div class="service-cards">
              <article class="service-card">
                ...
                <div class="service-button">
                  <a href="services/index.html#general" class="primary-button"
                    >一般歯科へ →</a
                  >
                </div>
              </article>
              <article class="service-card">
                ...
                <div class="service-button">
                  <a
                    href="services/index.html#prevention"
              ...
              <article class="service-card">
                ...
                <div class="service-button">
                  <a href="services/index.html#child" class="primary-button"
                    >小児歯科へ →</a
                  >
                </div>
              </article>
              <article class="service-card">
                ...
                <div class="service-button">
                  <a href="services/index.html#sergery" class="primary-button"
                    >口腔外科へ →</a
                  >
                </div>
              </article>
